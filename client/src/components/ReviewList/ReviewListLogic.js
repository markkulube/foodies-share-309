 ...
 * @param {string}      post        The post the review is for.  TODO: probably need to change type to unique identifier
 * @param {string}      content     The content body of the review.
 * @param {int}         rating      The rating of the review.
 */
export const handleCreateReview = (reviewList, username, post, content, rating) => {
